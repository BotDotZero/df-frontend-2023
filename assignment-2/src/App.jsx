...
function App() {
   ...
   function addBook(bookAdd) {
      ...
      const newBook = { id: lastId, name: bookAdd.name, author: bookAdd.author, topic: bookAdd.topic };
      ...
      <div className="App">
         ...
         <main className="container">
            <div className="action-bar">
               <input id="searchArea" type="text" placeholder="Search books" onKeyUp={(e) => setSearchValue(e.target.value)} />
            ...
            <Table books={currentBooks} booksPerPage={booksPerPage} showModal={showModal} />
